...
const CartItem = ({ item, itemIndex }) => {
  ...
  return (
    <div className="flex justify-center items-center flex-col  hover:scale-90 hover:border-[1px] border-gray-400 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl sm:flex-row">
